...
%% specifications.
%%
%% Here we are starting up the PackageCloud.io, Amazon S3 and
%% Google Analytics worker processes.
%%
%% @end
%%--------------------------------------------------------------------
-spec(init(Args :: term()) ->
...
init([]) ->
    ...
    S3Worker = {s3_id, {deploy_track_s3, start_link, []},
        Restart, Shutdown, Type, [deploy_track_s3]},
